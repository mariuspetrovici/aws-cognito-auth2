...
```bash
aws cloudformation delete-stack --stack-name Assist Masterclass April
```
...
Templaye.yaml anatomy - https://docs.aws.amazon.com/serverless-application-model/latest/developerguide/sam-specification-template-anatomy.html
AWS::Cognito:UserPool - https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cognito-userpool.html#cfn-cognito-userpool-schema
